...
Agora podemos simular a fase de grupos várias vezes e ver em quais delas o Brasil venceu determinados países e se foi selecionado ou não.
...
Tentamos pensar em outras estruturas de dados mais adequadas e eficientes para esse tipo de simulação, mas não descobrimos uma opção que permitisse realizar as operações que precisávamos.

Na hora de realizar a simulação utilizando o Google Cloud,

Como também não conseguimos prosseguir com a simulação das demais etapas da Copa, decidimos utilizar o Google Cloud para executar as operações em paralelo desta etapa.
